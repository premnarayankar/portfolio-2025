...
const items = [
  {
    ...
    desc: "A modern portfolio built with Next.js, React, Tailwind CSS, and Framer Motion — featuring smooth animations, responsive design, and integrated EmailJS for contact functionality.",
    img: "/portfolio.png",
