  ...
  const experienceData = [
    {
      ...
      description:
        "Building scalable fintech solutions with React, Ionic, and modern JavaScript frameworks.",
      date: "2022 - Present",
    ...
    },
    {
      ...
      description:
        "Worked on a variety of client projects, delivering full-stack web solutions.",
      date: "2020 - 2022",
      company: "Freelancer",
      position: "right",
    },
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            <p className="text-lg">
              ...
              always up for learning something new. Based in Mumbai, coding is
              my craft, and creating clean, user-first interfaces is what I do
              best.
            </p>
            {/* BIOGRAPHY QUOTE */}
          ...
          >
            ...
            >
              {experienceData.map((item, index) => (
                <div key={index} className="flex justify-between h-50">
                  {/* LEFT */}
                  <div className="w-1/3">
                    {item.position === "left" && (
                      <>
